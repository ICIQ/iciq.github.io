...
library(methods)
library(knitr)
opts_chunk$set(dev='svg', fig.width=2, fig.height=3, cache=TRUE, message=FALSE, warning=FALSE, comment=NA)

if(opts_chunk$get('dev') != 'svg') opts_knit$set(upload.fun = image_uri) 
local({
